...
public class DoctorService {
	...
	public Doctor getDoctorById(int doctorId) {
		return doctorRepository.findById(doctorId).orElse(null); // Return doctor or null if not found
	}

	// Save or update doctor
	public void saveDoctor(Doctor doctor) {
		doctorRepository.save(doctor); // This will either save a new doctor or update an existing one
	}
